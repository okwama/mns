...
--
-- Host: localhost:3306
-- Generation Time: Jul 22, 2025 at 03:37 PM
...
CREATE TABLE `attendance` (
  ...
  `is_early_departure` tinyint(4) NOT NULL DEFAULT 0,
...
--
-- Indexes for table `out_of_office`
--
ALTER TABLE `out_of_office`
  ADD PRIMARY KEY (`id`),
  ADD KEY `leave_requests_approved_by_fkey` (`approved_by`),
  ADD KEY `out_of_office` (`staff_id`);
...
ALTER TABLE `sales_order_items`
  ...
  ADD KEY `product_id` (`product_id`),
  ADD KEY `salesrep_order` (`salesrep`);
...
ALTER TABLE `stores`
  ...
  ADD KEY `country_relation` (`country_id`);
...
--
-- AUTO_INCREMENT for table `out_of_office`
--
ALTER TABLE `out_of_office`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `out_of_office`
--
ALTER TABLE `out_of_office`
  ADD CONSTRAINT `leave_requests_approved_by_fkey` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `out_of_office` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sales_orders`
--
ALTER TABLE `sales_orders`
  ADD CONSTRAINT `salesrep_id` FOREIGN KEY (`salesrep`) REFERENCES `SalesRep` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sales_order_items`
--
ALTER TABLE `sales_order_items`
  ADD CONSTRAINT `salesrep_order` FOREIGN KEY (`salesrep`) REFERENCES `SalesRep` (`id`);

--
-- Constraints for table `stores`
--
ALTER TABLE `stores`
  ADD CONSTRAINT `country_relation` FOREIGN KEY (`country_id`) REFERENCES `Country` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
